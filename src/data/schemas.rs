...
pub struct AdamBAM {
    ...
    pub start: i64,
    pub originalstart: i64,
    pub end: i64,
    pub mappingQuality: i32,
    pub readName: String,
    pub sequence: String,
    pub quality: String,
    pub cigar: String,
    pub basesTrimmedFromStart: String,
    pub basesTrimmedFromEnd: String,
    pub readPaired: bool,
    pub properPair: bool,
    pub readMapped: bool,
    pub mateMapped: bool,
    pub failedVendorQualityChecks: bool,
    pub duplicateRead: bool,
    pub readNegativeStrand: bool,
    pub mateNegativeStrand: bool,
    pub primaryAlignment: bool,
    pub secondaryAlignment: bool,
    pub supplementaryAlignment: bool,
    pub mismatchingPositions: String,
    pub readGroupId: String,
    pub readGroupSampleId: String,
    pub mateAlignmentStart: i32,
    pub mateReferenceName: String,
    pub insertSize: i32,
    pub readInFragment: i32,
